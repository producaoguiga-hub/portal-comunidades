    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {data.map(row => (
            <div key={row.id} className="bg-white rounded-xl border border-laranja/40 shadow-sm p-4 flex flex-col gap-3 hover:shadow-md transition-shadow relative overflow-hidden">
